        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> View Dimension </a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="<?php echo base_url('index.php/dimension/formAdd'); ?>" class="dropdown-toggle">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <h4 class="card-title">Dimension Data</h4>
                                    ...
                                    <table class="table">
                                        ...
                                        foreach ($data as $row){ ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['dimension_label']; ?></td>
                                                <td><?php echo $row['dimension_name']; ?></td>
                                                <td><?php echo $row['dimension_expl']; ?></td>
                                                <td class="td-actions text-right">
                                                    <a href="<?php echo base_url('index.php/dimension/formEdit/'.$row['dimension_id'])?>" type="button" rel="tooltip" class="btn btn-success btn-simple">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    <a href="<?php echo base_url('index.php/dimension/delete/'.$row['dimension_id'])?>" type="button" rel="tooltip" class="btn btn-danger btn-simple">
