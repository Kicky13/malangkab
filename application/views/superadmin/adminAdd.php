        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form method="post" action="<?php echo base_url('index.php/admin/add'); ?>" class="form-horizontal">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-md-6 col-sm-3">
                                            <select name="job" class="selectpicker" data-style="btn btn-primary btn-round" title="Single Select" data-size="7" required>
                                                ...
                                                <option value="<?php echo $item['position_id']; ?>"><?php echo $item['job_position']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
