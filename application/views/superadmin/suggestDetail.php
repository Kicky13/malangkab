                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <p>Berikut Saran pengembangan Berdasar hasil perhitungan kuesioner yang telah diperoleh untuk dimensi <?php echo $count['dimension']; ?> ada <?php echo $count['all']; ?> elemen yang menjadi bahan evaluasi, diantaranya ada <?php echo ($count['primary'] <= 0) ? "" : $count['primary']." elemen yang harus menjadi first priority dan "; ?><?php echo ($count['secondary'] <= 0) ? "" : $count['secondary']." elemen menjadi secondary priority dan "; ?><?php echo ($count['tersier'] <= 0) ? "semua elemen tersebut harus ditingkatkan atau dibenahi" : $count['tersier']." elemen sisa hanya cukup dipertahankan saja tidak harus dibenahi"; ?>. Berikut detailnya :</p>
                                <section <?php echo ($count['primary'] <= 0) ? "hidden" : ""; ?>>
                                ...
                                <section <?php echo ($count['secondary'] <= 0) ? "hidden" : ""; ?>>
                                ...
                                <section <?php echo ($count['tersier'] <= 0) ? "hidden" : ""; ?>>
