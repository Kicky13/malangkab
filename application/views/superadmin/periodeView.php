        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> Manage Periode </a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="<?php echo base_url('index.php/periode/add'); ?>" class="dropdown-toggle">
                                    ...
                                    <table class="table">
                                        ...
                                        foreach ($data as $row){ ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['periode_month']; ?></td>
                                                <td><?php echo $row['periode_years']; ?></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
