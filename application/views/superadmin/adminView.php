        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> Manage Administrator </a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="<?php echo base_url('index.php/admin/formAdd'); ?>" class="dropdown-toggle">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-actions text-right">
                                                <a href="<?php echo base_url('index.php/admin/formEdit/'.$row['admin_id'])?>" type="button" rel="tooltip" class="btn btn-success btn-simple">
                                                    <i class="material-icons">edit</i>
                                                </a>
                                                <a href="<?php echo base_url('index.php/admin/delete/'.$row['admin_id'])?>" type="button" rel="tooltip" class="btn btn-danger btn-simple">
