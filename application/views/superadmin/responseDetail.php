                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title">Detail Response -
                                    <small class="category">Response From Someone Who Evaluate The Website</small>
                                </h4>
                    ...
                    <div class="col-md-4">
                        <div class="card card-profile">
                            <div class="card-avatar">
                                <a href="#pablo">
                                    <img class="img"
                                         src="<?php echo base_url() . 'assets/admin/'; ?>img/faces/marc.jpg"/>
                                </a>
                            </div>
                            <div class="card-content">
                                <h6 class="category text-gray"><?php echo $bio['respondent_age'].'/'.$bio['respondent_address']; ?></h6>
                                <h4 class="card-title"><?php echo  $bio['respondent_name']; ?></h4>
                                <a href="<?php echo base_url('index.php/report/response'); ?>" class="btn btn-rose btn-round">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
