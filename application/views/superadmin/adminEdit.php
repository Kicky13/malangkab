        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form method="post" action="<?php echo base_url('index.php/admin/edit/'.$data['admin_id']); ?>" class="form-horizontal">
                                ...
                                <div class="card-content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <input type="text" class="form-control" name="nama" value="<?php echo $data['admin_name']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input type="text" class="form-control" name="nip" value="<?php echo $data['register_number']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-md-6 col-sm-3">
                                            <select name="job" class="selectpicker" data-style="btn btn-primary btn-round" title="Single Select" data-size="7" required>
                                                ...
                                                <?php foreach ($job as $item){ ?>
                                                    <option value="<?php echo $item['position_id']; ?>" <?php echo ($item['position_id'] == $data['position_id']) ? "selected":""; ?>><?php echo $item['job_position']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input type="password" disabled="" value="<?php echo $data['admin_password']; ?>" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input type="text" class="form-control" name="address" value="<?php echo $data['admin_address']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
